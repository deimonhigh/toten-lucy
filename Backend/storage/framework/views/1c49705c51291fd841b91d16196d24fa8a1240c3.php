                                ...
                                <?php $__currentLoopData = $dados; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td><?php echo e($data->estoque); ?></td>
                                            <td>
                                                <?php echo ($data->disabled ? '<i class="fa fa-ban text-danger"></i>' : '<i class="fa fa-check-square text-success"></i>'); ?>
                                            ...
                                            <td>
                                                ...
                                                <?php if(\App\Gate::hasAccess('admin/produtos/habilitar')): ?>
                                                    <?php if($data->disabled): ?>
                                                        <a class="btn btn-default"
                                                           title="Habilitar produto"
                                                           href="<?php echo e(url(route('habilitar', ['id' => $data->id, 'pesquisa' => (isset($_GET['pesquisa']) ? $_GET['pesquisa'] : '')]))); ?>">
                                                            Habilitar
                                                        </a>
                                                    <?php else: ?>
                                                        <a class="btn btn-default"
                                                           title="Desabilitar produto"
                                                           href="<?php echo e(url(route('desabilitar', ['id' => $data->id, 'pesquisa' => (isset($_GET['pesquisa']) ? $_GET['pesquisa'] : '')]))); ?>">
                                                            Desabilitar
                                                        </a>
                                                    <?php endif; ?>
                                                <?php endif; ?>
