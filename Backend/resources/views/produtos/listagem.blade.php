                                ...
                                @foreach($dados as $data)
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{ $data->estoque }}</td>
                                            <td>
                                                {!! ($data->disabled ? '<i class="fa fa-ban text-danger"></i>' : '<i class="fa fa-check-square text-success"></i>') !!}
                                            </td>
                                            <td>
                                                <a class="btn btn-default"
                                                ...
                                                @if(\App\Gate::hasAccess('admin/produtos/habilitar'))
                                                    @if($data->disabled)
                                                        <a class="btn btn-default"
                                                           ...
                                                           href="{{ url(route('habilitar', ['id' => $data->id, 'pesquisa' => (isset($_GET['pesquisa']) ? $_GET['pesquisa'] : '')])) }}">
                                                            Habilitar
                                                        </a>
                                                    @else
                                                        <a class="btn btn-default"
                                                           title="Desabilitar produto"
                                                           href="{{ url(route('desabilitar', ['id' => $data->id, 'pesquisa' => (isset($_GET['pesquisa']) ? $_GET['pesquisa'] : '')])) }}">
                                                            Desabilitar
                                                        </a>
                                                    @endif
                                                @endif
